...
export const SurveyTable = ({ onView }) => {
  ...
  const fetchSurveys = async () => {
    try {
      const response = await axios.get("https://alumnitracersystem.onrender.com/api/surveys");
  ...
  const handleDelete = async (surveyId) => {
    ...
    try {
      await axios.delete(`https://alumnitracersystem.onrender.com/api/surveys/${surveyId}`);
