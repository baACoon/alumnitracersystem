      ...
      {studentDetails && (
        <div className={styles.modalOverlay} onClick={closeStudentDetails}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <p>College: {studentDetails.personalInfo.college}</p>
            <p>Course: {studentDetails.personalInfo.course}</p>
            <p>Graduation Year: {studentDetails.personalInfo.gradYear}</p>
            <p>Email: {studentDetails.personalInfo.email}</p>
